`include "../8_bit_cla_adder/cla_8_bit.v"
`include "../8_bit_subtractor/sub_8_bit.v"
`include "../wallace_tree_multiplier/wallace_tree_multiplier.v"
`include "../non_restoring_divider/non_rst_div.v"
`include "../logic_unit/eight_bit_neg.v"
`include "../barrel_shifter/eight_bit_log_left.v"
`include "../barrel_shifter/eight_bit_log_right.v"
`include "../logic_unit/eight_bit_or.v"
`include "../logic_unit/eight_bit_and.v"
`include "../logic_unit/eight_bit_nand.v"
`include "../logic_unit/eight_bit_xor.v"
`include "../logic_unit/eight_bit_xnor.v"
`include "../logic_unit/eight_bit_not.v"
`include "../logic_unit/eight_bit_nor.v"
